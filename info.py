...
BOT_TOKEN = environ.get('BOT_TOKEN', '8356048538:AAG22LhchfW_EaP3rzenm4-sVyT8Z8Q1qv4')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6286894502').split()]
USERNAME = environ.get('USERNAME', "https://t.me/rishubhai1") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002790419863'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+kHV0qeEbCJFhNTdl')
